    ...
    render() {
        ...
        return (
            <Navbar color="#000000" dark expand="lg" fixed="top" id="header">
                <NavbarBrand tag={Link} to="/"><img src="/img/fetch-logo.png" className="img-fluid logo" /> <span className="d-none d-xl-inline-block"><T>Block explorer</T>&nbsp;</span></NavbarBrand>
